                    ...
                    if (loc_lat == loc1_lat && loc_long == loc1_long) {
                        ...
                        start1.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                int time;
                                String timer=database_handler.GetSettings(db,Database_handler.SETTINGS_REPORTING_TIME);
                                ...
                                Intent intent0 = new Intent(Transaction.this, Notification.class);
                                PendingIntent pendingIntent0 = PendingIntent.getBroadcast(Transaction.this, 0, intent0, 0);
                                Calendar timeOff9 = Calendar.getInstance();
                                timeOff9.set(Calendar.HOUR_OF_DAY, time);
                                ...
                                Transaction.this.finishAffinity();
                        ...
                        .setSingleChoiceItems(list,3, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                switch(which) {
                                    ...
                                    case 3:
                                        dialog.dismiss();
                                        startActivity(new Intent(Transaction.this,EmployeeDetails.class));
                                }
                            }
                        });
